<?php $subject_set = find_all_subjects($context_public = true); ?>
  ...
  <?php while ($subject = mysqli_fetch_assoc($subject_set)) { /* OPEN while loop for subject_set */ ?>
    <li>
      ...
      <div class="collapsible-body">
        <?php $page_set = find_pages_for_subject($subject["id"], $context_public = true); /* Get pages for current subject */
        ...
        <ul class="collapsible" data-collapsible="accordion"> <!-- Structure for page accordion -->
            ...
            <li>
              ...
              <div class="collapsible-body"> <?php echo nl2br(htmlentities($page["content"])); ?> </div>
            </li>
